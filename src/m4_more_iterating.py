...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 0
    actual = count_positive_sines([5, 4, 16,18])
    print()
...
def count_positive_sines(numbers):
    ...
    total = 0
    for item in numbers:
        if math.sin(item)>0: total = total + 1
    return total
...
def run_test_sum_first_n():
    ...
    # Test 2:
    expected = 48
    actual = sum_first_n([48, -10,88, 5], 1)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', actual)
